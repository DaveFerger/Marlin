...
#define STRING_CONFIG_H_AUTHOR "(DaveFerger, Geeetech A10)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A10 RevB [generated by Autotune]
  //#define DEFAULT_Kp 14.61
  //#define DEFAULT_Ki 0.70
  //#define DEFAULT_Kd 76.02

  // PID tuned for A10
  // import from Cirromulus/GeeeTech-A10-Marlin-2.0
